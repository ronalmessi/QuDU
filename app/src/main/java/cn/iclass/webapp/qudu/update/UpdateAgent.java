...
package cn.iclass.webapp.qudu.update;
...
//                onFailure(new UpdateError(UpdateError.UPDATE_NO_NEWER));
               ...
               UpdateUtil.setUpdate(mContext, mInfo.md5);
                mTmpFile = new File(mContext.getExternalCacheDir(), "QuDu-release-"+info.versionCode);
                mApkFile = new File(mContext.getExternalCacheDir(), "QuDu-release-"+info.versionCode+ ".apk");
